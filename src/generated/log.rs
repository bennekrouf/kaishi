...
pub mod log_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn stream_logs(
            ...
            tonic::Response<tonic::codec::Streaming<super::LogReply>>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            req.extensions_mut().insert(GrpcMethod::new("log.LogService", "StreamLogs"));
...
pub mod log_service_server {
    ...
    pub trait LogService: Send + Sync + 'static {
        ...
        type StreamLogsStream: tonic::codegen::tokio_stream::Stream<
                Item = std::result::Result<super::LogReply, tonic::Status>,
            >
            + Send
            + 'static;
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/log.LogService/StreamLogs" => {
                    ...
                    struct StreamLogsSvc<T: LogService>(pub Arc<T>);
                    impl<
                        T: LogService,
                    > tonic::server::ServerStreamingService<super::LogRequest>
                    for StreamLogsSvc<T> {
                        type Response = super::LogReply;
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as LogService>::stream_logs(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
